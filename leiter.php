        ...
        <div id="container" class="centered-box border border-primary rounded">
            ...
            <form action="leiterconference.php" method="post">
                ...
                <div class="input-group flex-nowrap">
                    ...
                    <input type="text" class="form-control" placeholder="Bsp.: Max Mustermann" aria-label="Vor- und Nachname" aria-describedby="fullname-description" id="fullname" name="fullname" required autofocus autocomplete="jitsi-name">
                </div>
                <br>
